...
<head>
	...
	<title>게시판</title>
	 	<style type="text/css">
			.pagi2 {list-style: none;float: left; padding: 6px;}
			.w_review{padding:0px 0px 0px 700px;}
			.search{padding:0px 0px 0px 600px;}
			.container1{padding:0px 0px 0px 600px;}
			.paging1{padding:0px 0px 0px 750px;}
...
<body>
    ...
    <button class="searchBtn btn btn-warning" type="button">검색</button>
    <script>
      $(function(){
  ...
  <ul class="pagination">
    <c:if test="${pageMaker.prev}">
    	<li class="pagi2"><a href="notice_list${pageMaker.makeSearch(pageMaker.startPage - 1)}">이전</a></li>
    </c:if> 

    <c:forEach begin="${pageMaker.startPage}" end="${pageMaker.endPage}" var="idx">
    	<li class="pagi2"><a href="notice_list${pageMaker.makeSearch(idx)}">${idx}</a></li>
    </c:forEach>

    <c:if test="${pageMaker.next && pageMaker.endPage > 0}">
    	<li class="pagi2"><a href="notice_list${pageMaker.makeSearch(pageMaker.endPage + 1)}">다음</a></li>
    </c:if> 
  </ul>
</div>
